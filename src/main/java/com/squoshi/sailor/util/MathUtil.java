...
public class MathUtil {
    /**
     * <p>
     * Perlin noise generator, specifically adapted for use in Sailor, a Minecraft mod.
     * </p>
     *
     * @author Ken Perlin, Matthew A. Johnston (WarmWaffles), squoshi
     *
     */
    // https://github.com/warmwaffles/Noise/blob/master/src/kenperlin/PerlinNoise.java
    public static class PerlinNoise {
        ...
        /**
         * A stub function that calls {@link #init(long)}
         *
         * @param seed
         */
		...
		*/
        ...
        public double randomFromSeed(double min, double max) {
            return min + (max - min) * noise(min, max);
        }
